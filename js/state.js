...
export class GameStore {
    ...
    getInitialState() {
        return {
            ...
            totalSeconds: 0, halfDuration: 30, currentGamePart: 1, isPassivePlay: false, isOpponent7v6: false, gameEvents: [], timelineEvents: [], gameSituationLog: [{ startTime: 0, endTime: null, situationA: 'equality', situationB: 'equality' }], lastKnownSituations: { A: 'equality', B: 'equality' }, teamAName: 'Minha Equipa', teamBName: ''
        };
    }
