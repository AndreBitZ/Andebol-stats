...
function playerRow(player) {
  ...
  return `<button type="button" onclick="window.togglePlayer(${JSON.stringify(player.Numero)})" class="w-full flex items-center justify-between gap-2 p-3 rounded-lg border ${classes} ${disabled} text-left" ${player.disqualified || player.isSuspended ? 'disabled' : ''}>
